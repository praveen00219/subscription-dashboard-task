  ...
  >
    <div className="flex items-start justify-between">
      <div className="flex-1">
        ...
        {link && (
          <Link to={link} className="text-blue-400 text-sm hover:underline">
            View Details →
          </Link>
        )}
      </div>
          ...
          {userSubscription ? (
            <div className="space-y-4">
              ...
              <div className="flex gap-4">
                ...
                <Link
                  to="/my-subscription"
                  className="flex-1 py-3 px-4 bg-gray-700 text-white font-bold rounded-lg text-center hover:bg-gray-600 transition"
                >
                  Manage Subscription
                </Link>
              </div>
